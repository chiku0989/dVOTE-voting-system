    ...
    return <div className={footerCss.footer}>
        <div className={footerCss.innerFooter}>
            <div className={footerCss.sec1}>
                <div className={footerCss.logoBox}>dVOTE</div>
            ...
            <div className={footerCss.sec2}>
                <div className={[footerCss.box1, footerCss.box].join(' ')}>
                    <div className={footerCss.boxTtl}>ABOUT dVOTE</div>
                ...
                <div className={[footerCss.box2, footerCss.box].join(' ')}>
                    <div className={footerCss.boxTtl}>Decentralized</div>
                    <a href="" className={footerCss.boxOpt}>dVOTE</a>
                    <a href="" className={footerCss.boxOpt}>Vote in India</a>
                    <a href="" className={footerCss.boxOpt}>Smart India</a>
                    <a href="" className={footerCss.boxOpt}>govt to India</a>
                </div>
                <div className={[footerCss.box3, footerCss.box].join(' ')}>
                    <div className={footerCss.boxTtl}>FOR Devs</div>
                    ...
                    <a href="" className={footerCss.boxOpt}>Eth For Work</a>
                </div>
            ...
            <div className={footerCss.sec3}>
                By continuing past this page, you agree to our Terms of Service, Cookie Policy, Privacy Policy and Content Policies. All trademarks are properties of their respective owners. Election Commission. All rights reserved.
            </div>
        </div>
    </div>
}
